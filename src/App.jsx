...
export default function Navbar() {
  ...
  return (
    // Create a div named Container using styled-components and add id="container"
    // Add border: 2px solid black and margin: auto
    // Create 4 divs inside container each with id="div1", id="div2", id="div3", id="div4" and add display:flex; justify-content:center to container
    <div></div>
  );
}
